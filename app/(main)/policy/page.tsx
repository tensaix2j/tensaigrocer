    ...
    <div className="max-w-4xl mx-auto p-6 sm:p-10 text-gray-800 dark:text-gray-100">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          and usage data when you interact with our website or application.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          data to improve functionality. These providers have their own privacy
          policies.
        </p>
      </section>
