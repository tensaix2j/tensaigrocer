    ...
    <div className="max-w-4xl mx-auto p-6 sm:p-10 text-gray-800">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          confidentiality of your login credentials and all activities under
          your account.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          All content, branding, and materials on this website are owned by us
          or licensed to us and are protected by applicable intellectual
          property laws.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          You agree not to engage in activities such as hacking, scraping,
          distributing malware, or any actions that could harm the platform or
          other users.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          any time, without notice, for conduct that violates these Terms.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          contact us at tensaix2j@gmail.com.
        </p>
      </section>
    </div>
  )
